...
class ShopBestellungenVBType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('erstellen', SubmitType::class, ['attr' => ['class' => 'btn btn-success btn-block fa fa-share-square-o'], 'label' => ' Vorgang erstellen'])
    ...
    {
        return 'shop_bestellungen_vb_type';
    }
}
